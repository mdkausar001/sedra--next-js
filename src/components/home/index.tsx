...
//   return (
//     <section
//       classNameName="relative bg-cover bg-center min-h-screen mt-[61px] overflow-hidden" // Margin-top added to prevent overlap
//       // style=
//       // {{
//       //   backgroundImage:
...
//     >
//       <video
//     classNameName="absolute top-0 left-0 w-full h-full object-cover"
...
//       <div classNameName="absolute inset-0  opacity-40 z-0"></div>

//       {/* Shape divider */}
//       <div classNameName="relative overflow-hidden z-10">
//         <svg
//           xmlns="http://www.w3.org/2000/svg"
//           viewBox="0 0 2600 131.1"
//           preserveAspectRatio="none"
//           classNameName="absolute inset-x-0 top-0"
//         >
//           <path
//             d="M0 0L2600 0 2600 69.1 0 0z"
//             fill="currentColor"
//             classNameName="text-gray-900"
//           ></path>
//           <path
//             d="M0 0L2600 0 2600 69.1 0 69.1z"
//             fill="currentColor"
//             classNameName="text-gray-900 opacity-50"
//           ></path>
//           <path
//             d="M2600 0L0 0 0 130.1 2600 69.1z"
//             fill="currentColor"
//             classNameName="text-gray-900 opacity-25"
//           ></path>
//         </svg>
//       </div>

//       <div classNameName="container mx-auto flex flex-col md:flex-row items-center justify-between py-16 relative z-10 mt-[15rem] ">
//         <div classNameName="md:w-1/2 space-y-4  lg:mt-8">

//           {/* <h1 classNameName="text-4xl font-bold text-white">
...
// <div classNameName="font-extrabold text-3xl md:text-4xl [text-wrap:balance] bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 to-50% to-slate-200">

// {/* <div classNameName="font-extrabold text-3xl md:text-4xl text-wrap:balance bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 to-50% to-slate-200">
//    From Imagination to Reality
// </div> */}
// <div classNameName="font-extrabold text-3xl md:text-4xl  font-quicksand text-wrap:balance bg-clip-text text-white bg-gradient-to-r from-slate-200/60 to-50% to-slate-200"
...
// {/* <span classNameName="text-mai inline-flex flex-col h-[calc(theme(fontSize.3xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
//                     <ul classNameName="block animate-textslide text-left"> */}
//                     {/* <span classNameName=" ml-2 text-mai inline-flex flex-col h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] md:h-[calc(theme(fontSize.4xl)*theme(lineHeight.tight))] overflow-hidden">
//                     <ul classNameName="block animate-textslide text-left text-5xl">
//                         {/* <li>Journey</li> */}
//                         {/* <li>iPaaS</li>
//                         <li>Zoho</li>
//                         <li>Cloud</li>
...
//                     </ul>
//                 </span> */}
// <h1 classNameName="text-4xl font-bold text-maiy" style={{ textShadow: '2px 2px 4px #323333' }}
// >
//         <Typewriter
//           options={{
...
//                 {/* <div classNameName="text-center flex justify-center items-center h-screen"> */}
//       {/* <div classNameName="relative">
//         <div
//           classNameName={`text-4xl font-bold ${
...
//           <p classNameName="text-white"  style={{ textShadow: '2px 2px 4px #323333' }}>
...
// <a
//   classNameName="inline-flex items-center justify-center py-1 text-center text-white font-normal text-body-color hover:text-mai hover:text-bold transition-all duration-300 ease-in-out"
//   href="#"
//   onClick={async (e) => {
//     e.preventDefault();
...
//     </svg>
//   </span>
//   <span classNameName="animate-float">Download Brochure</span>
// </a>
...
// export default function HomePage() {
//   return (
//     <section classNameName="relative flex min-h-screen items-center justify-center overflow-hidden">
//       {/* Background Video */}
//       <video
//         classNameName="absolute left-0 top-0 z-0 h-full w-full object-cover"
...
//       <div classNameName="absolute inset-0 z-10 bg-black bg-opacity-10"></div>

//       {/* Foreground content */}
//       <div classNameName="relative z-20 flex flex-col items-center justify-center text-center ">
//         <div classNameName="mt-32 flex  h-auto w-full flex-col items-center justify-center px-[3rem] sm:px-[60rem] md:px-[2rem] xl:px-[40rem] 2xl:px-[1rem]">
//           <h1 classNameName="bg-gradient-to-b from-[#ffffff] via-[#ffff]   to-[#cecdcd] bg-clip-text   text-3xl font-extralight  text-transparent sm:text-5xl   xl:text-6xl  2xl:text-9xl ">
//             Build Bespoke Software Solution for Your Business Growth
//           </h1>

//           <p classNameName=" mt-4 text-center text-sm font-superthin text-white 2xl:mx-20  xl:text-xl 2xl:text-2xl">
...
//         <div classNameName="mt-8 w-[90vw] overflow-x-auto lg:w-[95vw] 2xl:w-[95vw] 2xl:mt-20">
//           <div classNameName="flex flex-nowrap items-center justify-center gap-2 sm:gap-4 md:gap-2 xl:gap-4 scroll-smooth whitespace-nowrap pl-[34rem] md:pl-[26rem] lg:pl-[0rem] py-2 ">
//             {/* Card Wrapper */}

//             {/* card 1  */}
//             <div classNameName="scroll-snap-start flex h-48 min-w-[8rem] sm:min-w-[8rem] xl:min-w-[12rem] items-center justify-around rounded-2xl border border-neutral-700 bg-[#272727ab] text-center backdrop-blur-xl duration-200 ease-linear hover:bg-white hover:text-blue ">
//               <a
//                 classNameName="flex flex-col items-center justify-center text-sm "
//                 href=""
//               >
//                 {/* SVG */}
...
//                 <p classNameName="mt-8 font-light md:text-md  2xl:text-2xl">Fintech</p>
//               </a>
//             </div>

//             {/* card 2  */}

//             <div classNameName="scroll-snap-start  flex h-48 min-w-[8rem] xl:min-w-[12rem] items-center justify-around rounded-2xl border border-neutral-700 bg-[#272727ab] text-center backdrop-blur-xl duration-200 ease-linear hover:bg-white hover:text-blue sm:min-w-[8rem]">
//               <a classNameName="flex flex-col items-center justify-center " href="#">
//                 {/* SVG */}
...
//                 <p classNameName="mx-4 mt-8 text-center text-sm  md:text-md font-light 2xl:text-2xl">
...
//                 <p classNameName="mt-8 text-center text-sm  md:text-md font-light 2xl:text-2xl">
//                   Construction
//                 </p>
//               </a>
//             </div>
...
//             <div classNameName="scroll-snap-start flex h-48 min-w-[8rem] xl:min-w-[12rem] items-center justify-around rounded-2xl border border-neutral-700 bg-[#272727ab] text-center backdrop-blur-xl duration-200 ease-linear hover:bg-white hover:text-blue sm:min-w-[8rem]">
//               <a
//                 classNameName="flex flex-col items-center justify-center text-center text-sm"
//                 href=""
//               >
//                 {/* SVG */}
...
//                 <p classNameName="mt-8 text-center font-light text-sm  md:text-md 2xl:text-2xl">
...
//                 <p classNameName="mt-8 text-center text-sm  md:text-md font-light 2xl:text-2xl">Edtech</p>
//               </a>
//             </div>
...
//             <div classNameName="scroll-snap-start flex h-48 min-w-[8rem] xl:min-w-[12rem] items-center justify-around rounded-2xl border border-neutral-700 bg-[#272727ab] text-center backdrop-blur-xl duration-200 ease-linear hover:bg-white hover:text-blue sm:min-w-[8rem]">
//               <a
//                 classNameName="flex flex-col items-center justify-center text-center"
//                 href="#"
//               >
//                 {/* SVG */}
...
//         <div classNameName="mt-8 sm:mt-12 md:flex-row  flex flex-col h-20 w-full items-center justify-center gap-2">
//           <button classNameName="bg-[#2835f0] px-4 py-4 md:px-8 md:py-6  text-sm xl:text-2xl duration-150 hover:bg-[#2849b8] ">
//             Book a free consultation
//           </button>

//           <button classNameName="border-2 border-blue  px-4 py-3 md:px-8 md:py-6  text-sm xl:text-2xl duration-150 hover:bg-blue">
//             View Portfolio
//           </button>
//         </div>
//       </div>
...
// const HomePage = () => {
//   return (
//     <main classNameName="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
//       <h1 classNameName="text-4xl font-bold text-gray-800 mb-4">Welcome to the HomePage</h1>
//       <p classNameName="text-lg text-gray-600">This is a clean Next.js boilerplate component.</p>
//     </main>
//   );
// };
...
const HomePage: React.FC = () => {
  return (
    ...
    <div className="w-full bg-gray-800 flex flex-col items-center justify-start ">
       <CarouselBanner />
