    ...
    >
      <div className="grid max-w-6xl items-center   md:grid-cols-2">
        <div className="xl:ml-10">
          ...
          <p className="mb-4 text-gray-900">
            Fire Alarm Systems are critical safety solutions designed to detect
            and alert occupants to the presence of fire, smoke, or carbon
            monoxide threats through both visual and audible signals. These
            systems provide comprehensive, zoned coverage across residential,
          ...
          <ul className="mt-4 space-y-3">
            {[
              ...
              "Integration with building management and emergency systems for streamlined evacuation processes",
            ].map((item, i) => (
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        ...
        <p className="mb-6 text-center text-gray-700">
          We specialize in the design, installation, and maintenance of fire
          alarm systems, ensuring maximum protection, regulatory compliance, and
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            ...
            <p className="mb-4 text-gray-600">
              We deliver complete solutions tailored to your building’s unique
              needs..
            </p>
            <ul className="mt-4 space-y-3">
              {[
                ...
                "Emergency Communication Systems – Coordinate evacuation procedures and announcements",
              ].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
          ...
          <div className="flex items-center justify-center xl:ml-14">
            <Image
              src="/images/zoho/Zoho/Images/fireSystem1.jpg"
              alt="IT Strategy"
              width={400}
              height={300}
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="order-1 flex items-center justify-center md:order-none xl:mr-8">
            <Image
              src="/images/zoho/Zoho/Images/fireSystem2.jpg"
          ...
          <div>
            <h3 className="mb-2 text-xl font-semibold text-gray-800">
              Benefits of Implementing Fire Alarm Systems
            </h3>
            <p className="mb-4 text-gray-600">
              Installing a reliable fire alarm system offers crucial advantages
            ...
            <ul className="mt-4 space-y-3">
              {[
                ...
                "Integrated Safety Solutions – Work seamlessly with sprinklers, emergency lighting, and evacuation protocols",
              ].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
