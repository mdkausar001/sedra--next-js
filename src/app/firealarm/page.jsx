    ...
    <div className="flex flex-col items-center justify-center bg-white px-4 sm:px-6 lg:px-8 py-24 sm:py-24">
      <div className="grid max-w-6xl items-center   md:grid-cols-2">
        <div className="xl:ml-10">
          ...
          Fire Alarm Systems are critical safety solutions designed to detect and alert occupants to the presence of fire, smoke, or carbon monoxide threats through both visual and audible signals. These systems provide comprehensive, zoned coverage across residential, commercial, and industrial properties.
          </p>
          <ul className="mt-4 space-y-3">
            {["Audible Alarms such as loud sirens, bells, or voice alerts",
             "Visual Indicators like flashing lights or strobe signals",
              "Zoned System Design for targeted coverage and faster emergency response",
               "Integration with building management and emergency systems for streamlined evacuation processes"].map((item, i) => (
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Key Components of Fire Alarm Systems</h3>
            <p className="text-gray-600 mb-4">We deliver complete solutions tailored to your building’s unique needs..</p>
            <ul className="mt-4 space-y-3">
              {["Smoke and Heat Detectors – Sense fire hazards early and accurately",
               "Carbon Monoxide Detectors – Detect harmful gas leaks and alert occupants",
                "Alarm Signaling Devices – Combine loud alarms and flashing lights for clear evacuation signals",
                 "Control Panels – Centralized system management and monitoring",
                "Emergency Communication Systems – Coordinate evacuation procedures and announcements"].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
                  </span>
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Benefits of Implementing Fire Alarm Systems</h3>
            <p className="text-gray-600 mb-4">Installing a reliable fire alarm system offers crucial advantages for safety and risk management:</p>
            <ul className="mt-4 space-y-3">
              {["Early Detection and Warning – Provide more time for safe evacuation and response",
               "Life Safety – Protect occupants from fire, smoke, and gas-related incidents",
                "Property Protection – Minimize damage by alerting emergency responders sooner",
                 "Compliance Assurance – Meet fire safety codes and insurance requirements",
                  "Integrated Safety Solutions – Work seamlessly with sprinklers, emergency lighting, and evacuation protocols"].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
                  </span>
