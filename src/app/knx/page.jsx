    ...
    >
      <div className="grid max-w-6xl items-center   md:grid-cols-2">
        <div className="xl:ml-10">
          ...
          <p className="mb-4 text-gray-900">
            KNX is a globally recognized, standardized building automation
            system that allows centralized control and monitoring of essential
            systems such as lighting, HVAC, and security. Its open and flexible
            architecture ensures seamless integration with a wide range of
            devices and technologies.
          </p>
          <ul className="mt-4 space-y-3">
            {[
              "Standardized Communication Protocol for easy device integration",
              "Scalable and Flexible Design to fit buildings of all sizes and needs",
              "Wired and Wireless Connectivity for versatile installation options",
              "High Reliability and Interoperability across different manufacturers and systems",
            ].map((item, i) => (
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        ...
        <p className="mb-6 text-center text-gray-700">
          We offer comprehensive KNX solutions — from system design and
          integration to commissioning and maintenance — helping you achieve
          intelligent, efficient, and future-ready building management.
        </p>
        <div className="grid gap-10 md:grid-cols-2">
          <div>
            <h3 className="mb-2 text-xl font-semibold text-gray-800">
              Key Components of KNX Systems
            </h3>
            <p className="mb-4 text-gray-600">
              Our customized KNX solutions ensure full control, automation, and
              optimization of your building operations.
            </p>
            <ul className="mt-4 space-y-3">
              {[
                "KNX Sensors and Actuators – Measure, control, and automate building functions",
                "Control Panels and Interfaces – Enable user-friendly management and scheduling",
                "Wired and Wireless Networks – Support flexible deployment depending on building infrastructure",
                "Integration Modules – Connect KNX systems with lighting, HVAC, security, AV, and more",
              ].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
          ...
          <div className="flex items-center justify-center xl:ml-14">
            <Image
              src="/images/zoho/Zoho/Images/KNX1.jpg"
              alt="IT Strategy"
              width={400}
              height={300}
      ...
      <div className="mt-20 w-full max-w-6xl p-4 sm:p-10">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="order-1 flex items-center justify-center md:order-none xl:mr-8">
            <Image
              src="/images/zoho/Zoho/Images/KNX2.jpg"
          ...
          <div>
            <h3 className="mb-2 text-xl font-semibold text-gray-800">
              Benefits of Implementing KNX Systems
            </h3>
            <p className="mb-4 text-gray-600">
              KNX brings numerous operational and economic advantages to both
              new and existing buildings:
            </p>
            <ul className="mt-4 space-y-3">
              {[
                "Seamless Integration – Easily connect different devices and systems within one platform",
                "Energy Efficiency – Optimize lighting, heating, and cooling for lower operational costs",
                "Customization and Scalability – Adapt the system to evolving building requirements",
                "Enhanced Comfort and Convenience – Automate routines and optimize environments",
                "Long-term Reliability – Benefit from a robust and future-proof automation standard",
              ].map((item, i) => (
                <li key={i} className="flex items-center text-gray-900">
                  <span className="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-gray-200 text-green">
                    <FaCheck size={14} />
